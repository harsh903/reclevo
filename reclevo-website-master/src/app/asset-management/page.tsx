      ...
      <main className="space-y-10">
        ...
        >
          ...
          <div className="lg:col-span-1 flex justify-start order-2 lg:order-1 mt-10 lg:mt-0">
            ...
            >
              ...
              <p className="mt-3 !text-[#b1ba9b] dark:text-neutral text-base sm:text-lg md:text-xl leading-relaxed">
                Unhygienic conditions, citizen dissatisfaction, and rising
                operational costs affect overall public well-being.
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            <p className="mt-4 !text-[#0C5E41] dark:text-neutral-300 text-medium font-semibold sm:text-lg md:text-xl leading-relaxed">
              Municipalities and panchayats struggle with outdated tracking,
              poor visibility, and operational inefficiencies that lead to
              missed routes, breakdowns, payroll disputes, and non-compliance.
            </p>
            <ul className="mt-6 space-y-2 text-sm sm:text-base font-medium !text-[#0C5E41] dark:text-neutral-300">
              <li>• Unmonitored vehicles and missed routes</li>
              <li>• Reactive maintenance and frequent downtime</li>
              <li>• Manual attendance & payroll discrepancies</li>
              <li>• Limited visibility into day-to-day operations</li>
            </ul>
          </motion.div>
        </motion.section>
        ...
        >
          ...
          >
            ...
            <p className="mt-4 !text-[#0C5E41] dark:text-neutral-300 text-medium font-semibold sm:text-lg md:text-xl leading-relaxed">
              Simplify government waste operations with real-time tracking,
              predictive maintenance, and complete workforce visibility.
            </p>
            <ul className="mt-6 space-y-2 text-sm sm:text-base font-medium !text-[#0C5E41] dark:text-neutral-300">
              <li>• Live fleet monitoring</li>
              <li>• QR-enabled bin management</li>
              <li>• Automated maintenance scheduling</li>
              <li>• Digital attendance and reporting</li>
            </ul>
          </motion.div>
        ...
        >
          <div className="max-w-4xl">
            ...
            <p className="!text-gray-300 font-semibold text-sm sm:text-base md:text-lg mb-10">
              ...
              management challenges and create sustainable impact with AI and
              IoT technology.
            </p>
