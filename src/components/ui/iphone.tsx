...
export function Iphone({
  ...
  return (
    <div
      className={`relative inline-block  w-full max-w-[300px] sm:max-w-[350px] md:max-w-[400px] lg:max-w-[400px] align-middle leading-none ${className}`}
      style={{
    ...
    >
      {hasVideo && (
        <div
          className="pointer-events-none absolute z-0 overflow-hidden mt-20 h-full"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
