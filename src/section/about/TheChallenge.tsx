        ...
        >
          ...
          >
            ...
            <p className=" text-gray-700 mb-6 leading-relaxed text-sm sm:text-md lg:text-xl">
              ...
              change. We combine hands-on expertise with the latest technology
              to transform how India handles waste.
            </p>
            <p className=" text-gray-700 leading-relaxed text-sm sm:text-md lg:text-xl">
              With years of successful operations in Goa, deep knowledge of
              government consulting, and solid technological foundations,
              Reclevo is now expanding across India.
            </p>
          </motion.div>
        </motion.div>
